...
/**
 * AI Icon - Custom SVG icon for AI/Buddy feature
 * 
 * @param {Object} props - Component props
 * @param {number} props.size - Icon size (default: 24)
 * @param {string} props.color - Icon color (default: '#000000')
 * @param {number} props.strokeWidth - Stroke width (for consistency with lucide icons, but this icon uses fill)
 * @returns {JSX.Element} AI Icon component
 */
export const AIIcon = ({ size = 24, color = '#000000', strokeWidth }) => {
  return (
