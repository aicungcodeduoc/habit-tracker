...
--
-- For better organization, the schema is also split into:
...
-- END OF SCHEMA
-- =====================================================
-- Note: Storage setup (06_storage.sql) should be run separately after creating the bucket
-- Note: Migrations (07_migrations.sql) should be run only if updating an existing database